    ...
    return productData ? (
        <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
             ...
             <div className="flex gap-12 flex-col sm:flex-row">
               ...
               <div className="flex-1">
                 ...
                 <div className="flex flex-col gap-4 my-8">
                    <p>Select Size</p>
                    {/* Here I am facing an error */}
                    <div className="flex gap-2">
                          {productData.sizes.map((item,index)=>(
                            <button onClick={()=>setSize(item)} className={`cursor-pointer border py-3 px-4 bg-gray-100 ${item === size ? 'border-orange-500' : ''}`} key={index}>{item}</button>
                          ))}
                    </div>
                 </div>
             ...
             <div className="mt-20">
               ...
               <div className="flex flex-col border-none px-6 py-6 text-sm text-gray-500">
                 <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius, facere!</p>
                 <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, eligendi cumque explicabo nisi blanditiis quidem?</p>
               </div>
             </div>
